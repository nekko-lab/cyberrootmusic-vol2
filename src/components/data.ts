...
export const Caution: Array<ListBlock> = [
  ...
  {
    Content:
      "会場は通常の照明を落として営業しております。配線の都合上、床上をケーブルが通っている箇所がございますので足元には十分ご注意ください。",
  },
  {
    Content:
  ...
  {
    Content:
      "大学内で購入した酒類を含む飲食物の持ち込みは可能です。ただし、会場内の足元には電源などの配線が通っているため、周囲に十分注意してお楽しみください。万が一、飲食物を落としたりこぼしてしまった場合は、速やかに係員にご連絡いただき、清掃にご協力をお願いいたします。",
  },
